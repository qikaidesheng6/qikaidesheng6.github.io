...
```yml
# Site settings
title: Kai Blog             # title of your website
SEOTitle: Kai Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: Kaipro     # modify this account to yours
weibo_username: Kaipro      # the footer woule be auto-updated.
...
sidebar-avatar: /img/avatar-Kai.jpg     # use absolute URL.
```
...
It's possible that you want the two things different. For me, my site-title is **“Kai Blog”** but I want the title shows in search engine is **“黄玄的博客 | Kai Blog”** which is multi-language.
...
- Fixed [issue#15](https://github.com/qikaidesheng6/qikaidesheng6.github.io//Kaipro.github.io/issues/15) about code wrap.
